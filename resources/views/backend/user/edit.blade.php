                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" value="{{ !empty(old('name')) ? old('name') : $user->name }}">
                                </div>

                                <div class="form-group">
                                    <label for="sku" class=" form-control-label">Sku</label>
                                    <input type="text" id="sku" name="sku" class="form-control" value="{{ !empty(old('sku')) ? old('sku') : $user->sku }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address" name="address" class="form-control" value="{{ !empty(old('address')) ? old('address') : $user->address }}">
                                </div>

                                <div class="form-group">
                                    <label for="phone" class=" form-control-label">Phone</label>
                                    <input type="text" id="phone" name="phone" class="form-control" value="{{ !empty(old('phone')) ? old('phone') : $user->phone }}">
                                </div>
